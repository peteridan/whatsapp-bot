        ...
        run: async (context) => {
            ...
            try {
                ...
                const admins = metadata.participants
                    ...
                    .map(p => utils.getBaseUserId(p.id));
    ...
    promote: {
        run: async (context, args) => {
            ...
            try {
                ...
                await context.reply(`Promoted ${utils.getBaseUserId(target)} to admin.`);
            } catch (error) {
    ...
    demote: {
        run: async (context, args) => {
            ...
            try {
                ...
                await context.reply(`Demoted ${utils.getBaseUserId(target)} from admin.`);
            } catch (error) {
    ...
    add: {
        run: async (context, args) => {
            ...
            try {
                ...
                await context.reply(`Added ${utils.getBaseUserId(target)} to the group.`);
            } catch (error) {
    ...
    kick: {
        run: async (context, args) => {
            ...
            try {
                ...
                await context.reply(`Removed ${utils.getBaseUserId(target)} from the group.`);
            } catch (error) {
